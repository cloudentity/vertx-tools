...
public interface RequestCtxBuilder extends CallValuesBuilder<RequestCtxBuilder> {
  ...
  Future<HttpClientResponse> end(Pipe<Buffer> s);
  ...
  Future<HttpClientResponse> end(Pipe<Buffer> s, Handler<Buffer> bodyHandler);
  ...
  Future<SmartHttpResponse> endWithBody(Pipe<Buffer> s);
  ...
  Future<HttpClientResponse> end(TracingContext tracingContext, Pipe<Buffer> s);
  ...
  Future<HttpClientResponse> end(TracingContext tracingContext, Pipe<Buffer> s, Handler<Buffer> bodyHandler);
  ...
  Future<SmartHttpResponse> endWithBody(TracingContext tracingContext, Pipe<Buffer> s);
}
